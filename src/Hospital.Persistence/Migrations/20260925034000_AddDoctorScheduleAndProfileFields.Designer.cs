...
namespace Hospital.Persistence.Migrations
{
    ...
    [Migration("20260925034000_AddDoctorScheduleAndProfileFields")]
    partial class AddDoctorScheduleAndProfileFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hospital.Domain.Entities.InvoiceItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hospital.Domain.Entities.LabOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hospital.Domain.Entities.LabOrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("PerformedByLabTechId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hospital.Domain.Entities.LabTest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hospital.Domain.Entities.Medication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hospital.Domain.Entities.Prescription", b =>
                {
                    ...
                    b.Property<Guid?>("DispensedByPharmacistId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hospital.Domain.Entities.Invoice", b =>
                {
                    ...
                    b.HasOne("Hospital.Domain.Entities.LabOrder", "LabOrder")
                        .WithMany()
            ...
            modelBuilder.Entity("Hospital.Domain.Entities.LabOrder", b =>
                {
                    ...
                    b.HasOne("Hospital.Domain.Entities.MedicalRecord", "MedicalRecord")
                        .WithMany()
            ...
            modelBuilder.Entity("Hospital.Domain.Entities.LabOrderItem", b =>
                {
                    ...
                    b.HasOne("Hospital.Domain.Entities.LabTest", "LabTest")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("Hospital.Domain.Entities.PrescriptionItem", b =>
                {
                    b.HasOne("Hospital.Domain.Entities.Medication", "Medication")
